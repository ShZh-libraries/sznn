...
pub fn handle_padding(
    ...
    let out_data = match &input.get_data() {
        DTypes::F32(arr) => DTypes::F32(padding!(arr, in_shape, out_shape, output.get_length(), pad_top, pad_left, pad_bottom, pad_right)),
        DTypes::F64(arr) => DTypes::F64(padding!(arr, in_shape, out_shape, output.get_length(), pad_top, pad_left, pad_bottom, pad_right)),
